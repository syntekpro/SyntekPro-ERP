...
@section('content')
    <section class="space-y-6">
        <div>
            ...
            <h1 class="mt-3 text-4xl font-semibold text-ink">Accounts Receivable Aging</h1>
            <p class="mt-3 max-w-2xl text-sm text-muted">Outstanding customer credit balances bucketed by days overdue as of {{ $today->toDateString() }}.</p>
        </div>
            ...
            <div class="overflow-hidden rounded-ui border border-line table-baseline">
                <table class="min-w-full text-start text-sm ui-table">
                    ...
                    <tbody class="divide-y divide-line text-ink">
                        ...
                        @empty
                            <tr><td colspan="7" class="px-4 py-10 text-center text-muted">No outstanding customer balances.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
