<section class="space-y-6">
    <div>
        ...
        <h1 class="mt-3 text-4xl font-semibold text-ink">{{ $priceCategory ? 'Edit price category' : 'Create price category' }}</h1>
    </div>
    ...
    <form wire:submit="save" class="max-w-3xl rounded-ui border border-line bg-surface p-6">
        ...
        <div class="mt-8 flex gap-3">
            ...
            <a href="{{ route('price-categories.index') }}" class="btn-secondary">Cancel</a>
        </div>
    </form>
</section>