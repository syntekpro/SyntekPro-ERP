        ...
        @php
            ...
            $navSections = [
                ...
                ['key' => 'accounting', 'label' => __('Accounting'), 'icon' => 'landmark', 'items' => [
                    ...
                    ['label' => __('Bank Accounts'), 'route' => 'bank-accounts.index', 'patterns' => 'bank-accounts.*', 'icon' => 'landmark', 'visible' => \Illuminate\Support\Facades\Gate::allows('viewAny', \App\Models\BankAccount::class)],
                    ['label' => __('Bank Reconciliation'), 'route' => 'bank-reconciliation.index', 'patterns' => 'bank-reconciliation.*', 'icon' => 'git-compare-arrows', 'visible' => \Illuminate\Support\Facades\Gate::allows('viewAny', \App\Models\BankAccount::class)],
                ]],
                ...
                ['key' => 'administration', 'label' => __('Administration'), 'icon' => 'settings-2', 'items' => [
                    ...
                    ['label' => __('ZATCA Compliance'), 'route' => 'zatca-compliance.index', 'patterns' => 'zatca-compliance.*', 'icon' => 'shield-check', 'visible' => $canSettings || $canFinancialReports],
                ]],
            ];
