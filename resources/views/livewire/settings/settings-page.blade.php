    ...
    @if ($tab === 'general')
        <form wire:submit="saveGeneral" class="rounded-3xl border border-white/10 bg-white/5 p-6">
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div><label class="mb-2 block text-sm font-medium text-stone-200">Date format</label><input wire:model.live="settings.date_format" type="text" class="w-full rounded-2xl border border-white/10 bg-stone-900 px-4 py-3 text-stone-100 outline-none" /></div>
