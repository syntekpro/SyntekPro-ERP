    ...
    <form wire:submit="save" class="rounded-3xl border border-white/10 bg-white/5 p-6">
        ...
        <div class="mt-8 flex gap-3">
            ...
            @can('create', \App\Models\Cheque::class)
                <a href="{{ route('cheques.create', ['supplier_bill_id' => $supplierBill->id]) }}" class="rounded-2xl border border-amber-300/40 px-5 py-3 text-sm font-semibold text-amber-100 transition hover:bg-amber-500/10">Record cheque instead</a>
            @endcan
